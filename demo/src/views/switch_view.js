define(function(require, exports, module) {
    ...
    function SwitchView() {
        ...
        this.surface1.on('click', this.back.bind(this));
        // this.mainTransform.setTransform(Transform.translate(0, 0, 0), { duration: 500, curve: 'easeOut' });
    };

    SwitchView.prototype = Object.create(View.prototype);
    SwitchView.prototype.constructor = SwitchView;

    SwitchView.prototype.setSwitchAnimation = function(transform, settings) {
        this.mainTransform.setTransform(transform, settings);
    }

    SwitchView.prototype.back = function() {
        this.mainTransform.setTransform(Transform.translate(600, 0, 0), { duration: 500, curve: 'linear' });
